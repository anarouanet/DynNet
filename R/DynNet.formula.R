...
#'                          random.DeltaLP = ~ 1|1,
#'                          trans.matrix = ~ 1 + bs(x = time, knots =c(2), intercept = F, 
#'                                                  degree = 2),
#'                          delta.time = Delta)
...
#'                            varcovRE = c(1.000, 0.000, 0.473, 0.000, 1.000, 0.000, 0.057, 
#'                                         -0.182, 0.000, 0.174), 
#'                            fix.varcovRE = c(1, 1, 0, 1, 1, 1, 0, 0, 1, 0),
#'                            transitionmatrix = c(-0.523, 0.000, 0.000, 0.000, 0.073, 0.083, 0.119, 
#'                                                 0.106, 0.015,  0.157,  0.054, 0.087, -0.079, 
#'                                                 0.000, 0.000, 0.000), 
